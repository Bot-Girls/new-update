        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Created By: Team Girls")
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
			...
			cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"αυтσ ℓιкє ву ѕρє¢ιαℓ αиιмє/https://line.me/R/ti/p/%40kyx3655e")
