...
cl =  LINETCR .LINE ()
cl.login ( token = "EnNEPBynWKK5UWZlqq95.wNC+p7SE2pQ7atQuudNWXq.c5KQe34Wtj13tdeqp5lYmrvhV0aPo0brpb7mLrckdE4=")

ki =  LINETCR .LINE ()
ki.login ( token = "Enu5gfyvs66yeXgxKLn6.F+TmYjhlQigThWCurQaIHG.V3gmdiEJRsbXZoVq08cUQbTren5dRmfyQAJNbt8AeMI=")

kk =  LINETCR .LINE ()
kk.login ( token = "En7o2QysjISJO2GGpoF5.v2JPnboPPyP39+KLXrlz5q.4RXQwRROrUKWAtL51ySt/EfhZIDWOFJN/9RO5KFy5RM=")

kc =  LINETCR .LINE ()
kc.login ( token = "EnyzmK2PD4Ex3tIAq66f.H1B9vvZE2Qt5uJ/vr9757W.BrF3QgmpyCZ5QlU0yarDIB+jZOpRcRmgeRjHa+47btU=")
...
[One bye] = Mengeluarkan bot utama
[Bye all] = Mengeluarkan bot utama dari semua grup
[Bc ...] = Untuk broadcast ke semua grup
[Bot:restart] - Untuk Restart Bot
[Add admin @] - Tambahkan admin @
[Remove admin @] - Hapus admin @
[Adminlist] - Daftar admin
[/translate-en] - Translate Inggris - Indonesia
[/translate-id] - Translate Indonesia - Inggris
...
Bots=[mid,Amid,Bmid,Cmid,"ucbd1374cb68242824dc21abcd7d6f669"]
admin=["ucbd1374cb68242824dc21abcd7d6f669","u3fa0c0964985cd663d1fce84507e9b9b"]
admsa=["ucbd1374cb68242824dc21abcd7d6f669","u3fa0c0964985cd663d1fce84507e9b9b"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "dblack":False,
    "clock":False,
    "cName":"f̶S̶E̶R̶K̶~B̶O̶T̶~I̶f̶",
    "cName2":"f̶S̶E̶R̶K̶~B̶O̶T̶~2̶f̶",
    "cName3":"f̶S̶E̶R̶K̶~B̶O̶T̶~3̶f̶",
    "cName4":"f̶S̶E̶R̶K̶~B̶O̶T̶~4̶f̶",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ucbd1374cb68242824dc21abcd7d6f669":
                    if "join:" in msg.text:
        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Created By: ~SERK*TEAM~")
...
#Restart_Program
    ...
    #-------------Fungsi Tag All Finish---------------#
       ...
       #--------------Fungsi Broadcast Finish-----------#
                ...
                ki.sendText(msg.to,"Hi Juga Sayang ku")
                kk.sendText(msg.to,"Iya sayang􏿿")
                kc.sendText(msg.to,"Kemana aja kok baru ada kabar selingku ya")

#-----------------------------------------------

            elif msg.text in ["Girl","Girls"]:
    ...
    #--------------------------------------------------------
              ...
              if msg.from_ in Creator:
                if admin == []:
                    ...
                    mc = ""
                    for mi_d in admin:
                        mc += "List Admin  fÌ¶SÌ¶EÌ¶RÌ¶KÌ¶~BÌ¶OÌ¶TÌ¶ " +cl.getContact(mi_d).displayName + "\n"
      ...
      #-------------Fungsi Bannlist Finish------------------#  
			  ...
			  if msg.from_ in admsa:
				...
				for i in gid:
					...
					kc.leaveGroup(i)
				if wait["lang"] == "JP":
					cl.sendText(msg.to,"Ledies Squad bot leaving all groups.")
				else:
					cl.sendText(msg.to,"He declined all invitations")
            elif msg.text.lower() == 'Ledies out':
			  if msg.from_ in admsa:
				gid = cl.getGroupIdsJoined()
				for i in gid:
					cl.leaveGroup(i)
				if wait["lang"] == "JP":
					cl.sendText(msg.to,"Ledies bot leaving all groups.")
				else:
					cl.sendText(msg.to,"He declined all invitations")
              ...
              if msg.from_ in admin:
				...
				jawab = ("Ya","Tidak"," Mungkin iya","Mungkin")
