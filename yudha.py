...
cl =  LINETCR .LINE ()
cl.login ( token = "Em7j3LeBF5gzJxBSdJK3.2C54SsfW3HH1kWYh7OaMWW.zs1ZUcHVD/L3wGjILZx8P3M5OlzHW9WZGgYKKDFKoSc=")

ki =  LINETCR .LINE ()
ki.login ( token = "EmXs7ylHLG9pDPfeXBIe.60NNbOgNoAeqMp1L62cEpG.4SMyOr0F/5snleNrML8Sa2cTUo/XhRE6L0tSvNvboOg=")

kk =  LINETCR .LINE ()
kk.login ( token = "EmR7rRWVBbpVayhnDf7d.GA7t2NpAkdgSX0KBSyP3Fq.WTjQb4DhE/agUB3jR50P5CnsNMdy98GAM8Vp5yx17bo=")

kc =  LINETCR .LINE ()
kc.login ( token = "Em5i9ukIcwPMSjYzNhv4.T2VtN7n/mDvFrkBwmVqQDa.pWjoH6UZZAPRuLh0W6BwPsMdhGgaq2/y5WQlZFZlKuM=")
...
Bots=[mid,Amid,Bmid,Cmid,"u62c0d31464d0c466a6e90534ee1d39f4"]
admin=["u62c0d31464d0c466a6e90534ee1d39f4"]
admsa=["u62c0d31464d0c466a6e90534ee1d39f4"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u62c0d31464d0c466a6e90534ee1d39f4":
                    if "join:" in msg.text:
        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Created By: мєяяу")
                msg.contentMetadata = {'mid': 'ue78b84e555c7640671975690b6df2712'}
                cl.sendMessage(msg)
            elif msg.text in ["Me"]:
                msg.contentType = 13
