...
cl =  LINETCR .LINE ()
cl.login ( token = "Emwl1WCKsxexQK0L9vM0.hIvl/2gfxP6SsXSqGjs2aa.fLcVjgklHWl3p+bhLglr0yIW8auB/k/jsWuiNktdhi0=")

ki =  LINETCR .LINE ()
ki.login ( token = "EmQGPi5HQOmLNIQ7xied.GA7t2NpAkdgSX0KBSyP3Fq.Mjabq+ilDSDmhgHYKy7KMmuatLfHuamhweOj/Y6k/5E=")

kk =  LINETCR .LINE ()
kk.login ( token = "Em7j3LeBF5gzJxBSdJK3.2C54SsfW3HH1kWYh7OaMWW.zs1ZUcHVD/L3wGjILZx8P3M5OlzHW9WZGgYKKDFKoSc=")

kc =  LINETCR .LINE ()
kc.login ( token = "EmRDwgRF4hktAb8N3db9.r9C7KyV32gZPqgpscode6q./xL3rTt4/U7e+tzrfwMvWF5NB4JEYa6jD89ZBcciDxE=")
