...
cl =  LINETCR .LINE ()
cl.login ( token = "EmEbK2lkSuasXCMTRcW0.hIvl/2gfxP6SsXSqGjs2aa.nyW8alN6ypmKbiLeKQ32W39uKalOWrFoZ6MWwOt44SU=")

ki =  LINETCR .LINE ()
ki.login ( token = "EmJByu5iVDBG4VnPCLSe.DNcjB3AgaMigrbmdeISphG.sD1S21TATNAp9Dpitg0KwoyTssy7OxE9yrNzG/nXmfE=")

kk =  LINETCR .LINE ()
kk.login ( token = "EmZ8tBHIjmFsEsXrBSm3.2C54SsfW3HH1kWYh7OaMWW.HxJgNCo+cZpDH4SoZJtWIivv4t8/OkqqpzSL9lfCW3g=")

kc =  LINETCR .LINE ()
kc.login ( token = "Emc8n9qvrWmcd6E3bDa5.hiIwQE9ldFfhL3a8C94l5q.QAEljNZ1DsYRKsPMlSCs9fvTRUUHSHh897LdZgBSc8I=")
...
[Merry join] = Mengeluarkan bot utama
[Merry bye] = Mengeluarkan bot utama dari semua grup
...
Bots=[mid,Amid,Bmid,Cmid,"u30ef8888fc6633edaef95fe68c686c48","u1e254bfb61855e9eac4b1b108094b600"]
admin=["u30ef8888fc6633edaef95fe68c686c48","u1e254bfb61855e9eac4b1b108094b600"]
admsa=["u30ef8888fc6633edaef95fe68c686c48","u1e254bfb61855e9eac4b1b108094b600"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks for adding me\nPengen punya like banyak add oa ini; https://line.me/R/ti/p/%40kyx3655e",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u30ef8888fc6633edaef95fe68c686c48","u1e254bfb61855e9eac4b1b108094b600"
                    if "join:" in msg.text:
        ...
        if op.type == 26:
	       ...
	       if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Created By: sρεcιαℓ αηιмε")
...
#-----------------------------------------------
      ...
      #-------------Fungsi Bannlist Finish------------------#  
            ...
            elif msg.text.lower() == 'Sayang bye all':
